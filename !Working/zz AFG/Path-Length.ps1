<#
    ...
    Author   : Aaron Price
    Company  : AFG
    Purpose  : Find files with invalid file path and characters before sync to Sharepoint online directory because of limitations at current time.
    ...
    Date: 08/09/2017 | Tested on Mapped Share on Local machine 
