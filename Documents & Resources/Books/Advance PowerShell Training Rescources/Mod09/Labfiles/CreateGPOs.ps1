...
#this script should be run in a PowerShell session on the domain controller.
#It assumes the OUs 'Human Resources' and 'North' have already been created.

import-module GroupPolicy

new-gpo -name "HR Users" -StarterGpoName "Windows Vista EC User" | 
new-gplink -target "OU=Human Resources,$((get-addomain).distinguishedname)"

new-gpo -name "North XP Clients" -StarterGpoName "Windows XP SP2 EC Computer" | 
new-gplink -target "OU=North,$((get-addomain).distinguishedname)"

write-host "New GPOs created." -foreground Green
# SIG # Begin signature block
# MIIbEQYJKoZIhvcNAQcCoIIbAjCCGv4CAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUaOAyt2Nku1HNiB9GDzoJlack
# gdWgghXqMIIEhTCCA22gAwIBAgIKYQX3HgAAAAAAMjANBgkqhkiG9w0BAQUFADB5
...
# BgorBgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQU9a1Y
# kop+PmaVFCqN7XF2TCjfytwwXgYKKwYBBAGCNwIBDDFQME6gJoAkAE0AaQBjAHIA
# bwBzAG8AZgB0ACAATABlAGEAcgBuAGkAbgBnoSSAImh0dHA6Ly93d3cubWljcm9z
# b2Z0LmNvbS9sZWFybmluZyAwDQYJKoZIhvcNAQEBBQAEggEAKH7L/xv5ObcCQu6R
# OAy8KfIUSbGiSnQJdvrJuREEZWQdq0SNNNF7a7A+UAU2PHXhFQmJo0byRsqlmkAf
# ePiQjmi7mtXIi5MO/839SvxkXR1wPY6yR4Ep9gv0lfvSDYc5MqsAWz379P+0As4M
# 9i86JwYqsO0KLtUFMxTu5ek+q8Kh9Zl3VINFSa34VqO0iBplLpVzpqrcDd4SrYiY
# m2K70Rg82OaUZapuH8HHDEnXs9sdS81XWVBS1AW6GW4kRmFJfZZWsTug4AsPLGhk
# FsLN31T4MW3ZBznPqt+lZi8z/Ek97wDlvGKhFma81HQb4ZbXnvDnt7tzZGfdZJg4
# lBiFWaGCAh0wggIZBgkqhkiG9w0BCQYxggIKMIICBgIBATCBhTB3MQswCQYDVQQG
...
# CQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0xMDA4MDkxNzM2MTlaMCMG
# CSqGSIb3DQEJBDEWBBRq/52Gs0Zj21AcLsU826qI/TKmpDANBgkqhkiG9w0BAQUF
# AASCAQCnIIWO772uIVF2mr6DDFZltmi5YHPWnpzYuQKbC/J0UW9mmcqVHbYVP96K
# oGMz+FbhryFzE9OuhXrVEe1YwaG/a1rSEZOQ6YJEg/ULJFHqUA+S2awTjCvzLYbW
# AX+nEW/m6Ji5cMSWPxM6RMaCIrSNrd6cXnUMGUfbH727ej7e8qzEzUAHm6I+lNFn
# dSE8agOElAQsumqNTm5WAgqKTj9U5iUlligoESQnoffPZQt7CgOYJcZqBB6K+6yC
# I8etyKQ9wVyiJvIxBVabJHQl03Fl+iLYHsMIQGq3iMw/IzoJOKuHLhQfaRKYBj4a
# 0pNavOMAwp0YZDAKHradQbqSOzLd
